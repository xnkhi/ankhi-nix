"use strict";
(() => {
  // src/connectors/1001tracklists.ts
  var nextCue;
  var cue;
  var currentTime;
  var mixDuration = Util.stringToSeconds(
    Util.getTextFromSelectors(".mediaTabItm:not(.hidden) .active")?.split("[")[1].split("]")[0]
  );
  Connector.playerSelector = "#playerWidgetFields";
  Connector.getTrackArt = () => Util.getAttrFromSelectors(".cPlay .artM", "data-src");
  ...
  Connector.isPlaying = () => Util.hasElementClass("#playerWidgetPause", "fa-pause");
