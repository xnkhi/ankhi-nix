"use strict";
(() => {
  // src/connectors/radioparadise.ts
  ...
  Connector.isPlaying = () => {
    return Util.getAttrFromSelectors("#global-player mat-icon", "title") === "Pause";
  };
  ...
  Connector.scrobblingDisallowedReason = () => {
    return Util.getTextFromSelectors(".player-bar .player-title")?.includes(
      "Listener-supported"
    ) || Connector.getArtist()?.startsWith("Commercial-Free") ? "FilteredTag" : null;
  };
})();
