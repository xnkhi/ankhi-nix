"use strict";
(() => {
  // src/connectors/newgrounds.ts
  var globalArtistSelector = ".ng-apg-media-artist";
  var globalTrackSelector = ".ng-apg-media-title";
  var embeddedArtistSelector = ".item-user h4";
  var embeddedTrackSelector = ".pod-head h2";
