"use strict";
(() => {
  // src/connectors/dandelionradio.ts
  ...
  Connector.getTrackInfo = () => {
    ...
    if (artistTrackElement && artistTrackElement.childNodes.length > 2) {
      return {
        ...
        track: artistTrackElement.childNodes[2].textContent?.substring(3)
        // omit dash and spaces
      };
    }
    return null;
  };
  ...
  Connector.scrobblingDisallowedReason = () => Connector.getTrackInfo() ? null : "Other";
})();
