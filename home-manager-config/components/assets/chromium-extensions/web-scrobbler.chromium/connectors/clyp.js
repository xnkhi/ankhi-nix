...
(() => {
  ...
  function setupCardsPlayer() {
    ...
    Connector.getArtist = () => {
      ...
      const container = [...cards].filter(
        (element) => element.classList.contains("pause-button")
      )[0];
    ...
    Connector.isPlaying = () => Boolean(document.querySelector(".pause-button.small"));
  }
  function setupPlayerPage() {
    ...
    Connector.isPlaying = () => Boolean(document.querySelector(".soundwave-container > .pause-button"));
  }
  setup();
})();
