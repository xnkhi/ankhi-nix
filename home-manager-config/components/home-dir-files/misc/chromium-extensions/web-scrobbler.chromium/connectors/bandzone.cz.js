...
(() => {
  ...
  function isMainPage() {
    return location.href === "http://bandzone.cz/" || location.href === "https://bandzone.cz/";
  }
  function setupMainPagePlayer() {
    ...
    Connector.isPlaying = () => Boolean(document.querySelector(".ui-miniaudioplayer-state-playing"));
  }
  function setupDefaultPlayer() {
    ...
    Connector.isPlaying = () => Util.getTextFromSelectors(".ui-audioplayer-button") === "stop";
