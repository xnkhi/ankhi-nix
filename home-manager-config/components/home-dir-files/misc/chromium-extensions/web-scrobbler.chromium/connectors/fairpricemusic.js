"use strict";
(() => {
  // src/connectors/fairpricemusic.ts
  ...
  function isPlaylist() {
    return Util.getAttrFromSelectors("#audio_player_section audio", "id") === "hpPlayer-player";
  }
  ...
  function isAlbum() {
    return Util.getAttrFromSelectors("#audio_player_section audio", "id") === "albumPlayer-player";
  }
  ...
  function isBandPage() {
    return Util.getAttrFromSelectors("#audio_player_section audio", "id") === "bandPlayer-player";
  }
