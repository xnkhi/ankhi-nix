"use strict";
(() => {
  // src/connectors/cpr.ts
  var filter = MetadataFilter.createFilter({ album: removeAlbumPreface });
  ...
  Connector.scrobblingDisallowedReason = () => Connector.getArtist() ? null : "Other";
